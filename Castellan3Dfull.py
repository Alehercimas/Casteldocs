# The whole repository (barring some outliers) of my functions
# for rotating a Bezier surface patch in any axis.
# All functions for one, two and three rotations.
...
def surfmultx(Psur, trn, turns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
...
def surfmultxy(Psur, xtrn, ytrn, xturns=1, yturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
...
def surfmultxz(Psur, xtrn, ztrn, xturns=1, zturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
...
def surfmultyz(Psur, ytrn, ztrn, yturns=1, zturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
...
def surfmultyx(Psur, ytrn, xtrn, yturns=1, xturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
...
def surfmultzx(Psur, ztrn, xtrn, zturns=1, xturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
...
def surfmultzy(Psur, ztrn, ytrn, zturns=1, yturns=1):
    fig = plt.figure(figsize=(8,8))
    ax = fig.gca(projection='3d')
    count = np.arange(11)
    mpar = np.linspace(0,1,11)
    ...
    allcoors = np.array([0,0,0])
    graphlims = np.zeros(6)
    turnstiley = np.arange(zturns)+1
    turnstilez = np.arange(yturns)+1
    for k in turnstilez:
        for l in turnstiley:
            allcoors = np.array([0,0,0])
            for m in count:
