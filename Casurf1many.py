# Like the Casurf1 function but you can take multiple arguments, basically multiple surfaces on one.
...
def surfbez(*Psur): # multiple variants of "Psur"
    ...
    for l in Psur:
        ...
        for m in count:
            for n in count:
                coors = surfcast(l, mpar[m], npar[n])
